"""Lazy heatmap export surface for package-owned and bridged plotters."""
...
_MODULE_IMPORTS = {
    ...
    "jaccard_heatmap_plotter": (
        ".._legacy.logitdiff_toolkit.logit_lens_methods.plotting.heatmaps.jaccard_heatmap_plotter"
    ),
...
def __getattr__(name: str):
    ...
    if name in _MODULE_IMPORTS:
        return import_module(_MODULE_IMPORTS[name], __package__)
