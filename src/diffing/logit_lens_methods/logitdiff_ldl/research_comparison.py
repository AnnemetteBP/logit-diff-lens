...
from ..wrapper import GenerationLensWrapper, LogitLensWrapper, normalize_activations
...
def _project_wrapper_hidden_state_to_logits(
    wrapper: LogitLensWrapper | GenerationLensWrapper,
    hidden_state: torch.Tensor,
    *,
    block: str,
    layer_index: int,
