...
def save_mds_errorbar_plot(
    ...
    *,
    ...
    _, harmful_ci = _bootstrap_mean_diff(harmful, np.zeros_like(harmful), n_bootstrap=n_bootstrap, seed=seed)
    _, neutral_ci = _bootstrap_mean_diff(neutral, np.zeros_like(neutral), n_bootstrap=n_bootstrap, seed=seed + 1)
