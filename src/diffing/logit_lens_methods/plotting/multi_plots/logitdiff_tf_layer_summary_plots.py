...
def save_tf_logit_metric_summary_plots(
    ...
    *,
    ...
    fig.suptitle(
        "Teacher-forcing layer-wise logit comparison",
        fontsize=18,
        fontweight="bold",
        y=0.995,
    )
...
def save_tf_hidden_metric_summary_plots(
    summary_path: str | Path,
    *,
    output_png: str | Path,
    output_pdf: str | Path | None = None,
    ...
    fig.suptitle(
        "Teacher-forcing hidden-state comparison",
        fontsize=18,
        fontweight="bold",
        y=0.972,
    )
