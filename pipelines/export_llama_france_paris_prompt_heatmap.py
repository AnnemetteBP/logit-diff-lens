...
def main() -> None:
    base_prompt_path = "/media/am/AM/logit-diff-lens/tmp/llama_france_paris_prompt/base_prompt_artifact.pt"
    ft_prompt_path = "/media/am/AM/logit-diff-lens/tmp/llama_france_paris_prompt/bitnet_prompt_artifact.pt"
    ...
    prompt_out = Path("/media/am/AM/logit-diff-lens/Figures/LLaMA/llama_france_paris_prompt_heatmap.pdf")
